...
export { DEFAULT_METRICS, bandHeight, computeLayout, } from '../lib/layout.js';
export { drawDocument } from '../lib/renderer.js';
export { watermarkRect } from '../lib/watermark.js';
// Serialization: back-compat normalization, JSON import/export, storage keys.
export { normalizeDocument } from '../lib/normalize.js';
export { documentToJson, parseImportedDocument, } from '../lib/import-export.js';
