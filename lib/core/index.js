...
export { DEFAULT_METRICS, bandHeight, computeLayout, } from '../lib/layout';
export { drawDocument } from '../lib/renderer';
export { watermarkRect } from '../lib/watermark';
// Serialization: back-compat normalization, JSON import/export, storage keys.
export { normalizeDocument } from '../lib/normalize';
export { documentToJson, parseImportedDocument, } from '../lib/import-export';
